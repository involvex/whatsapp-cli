    ...
    return (
      ...
      >
        ...
        <Box flexDirection="column" marginTop={1}>
          <Text>
            A minimal terminal-based WhatsApp client with AI integration.
          </Text>
          <Box marginTop={1}>
    ...
    return (
      ...
      >
        ...
        <Box flexDirection="column" marginTop={1}>
          <Text>
            AI Provider:{" "}
            <Text color="magenta">{config.aiProvider.provider}</Text>
          </Text>
          <Text>
            AI Model: <Text color="magenta">{config.aiProvider.model}</Text>
          </Text>
          ...
          <Text>
            Chat History: {config.chatHistoryEnabled ? "Enabled" : "Disabled"}
          </Text>
        </Box>
        <Box marginTop={1}>
          <Text dimColor>
            Interactive settings coming soon! Edit config.json for now.
          </Text>
        </Box>
        <Box marginTop={1}>
          <Text dimColor>Press any command key to go back.</Text>
